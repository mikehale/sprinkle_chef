...
Use sprinkle to bootstrap your chef server:
  rake chef:server CHEF_HOST=your-chef-server

Or client:
  rake chef:client CHEF_HOST=your-chef-client
...
You can run `rake add_ssh_key CHEF_HOST=your-chef-host` to add your public key to root@CHEF_HOST.
Take a look at {link this article}[http://www.debian-administration.org/articles/530] for more 
